package net.mrconqueso.lightsabers.common.item.util;
...
public interface ILightsaberComponent
{
     ...
     * @return The bits that this item will add to a {@link net.mrconqueso.lightsabers.common.lightsaber.LightsaberData} object.
     */
